...
local function zettelkasten()
    keymaps.register({ "n" }, {
        ["<leader>zz"] = "<Cmd>ZkNew { title = vim.fn.input('Title: '), dir = 'zettel' }<CR>",
        ["<leader>zd"] = "<Cmd>ZkNew { group = 'daily', dir = 'dailies' }<CR>",
    ...
    keymaps.register({ "n" }, {
        ["<leader>zz"] = ":'<,'>ZkNewFromTitleSelection { dir = 'zettel' }<CR>",
