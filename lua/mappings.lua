...
local function navigations()
    keymaps.register("n", {
        ...
        ["<C-e><C-e>"] = [[<cmd>lua require'nvim.yazi'.open('')<cr>]],
        ["<C-e><C-t>"] = [[<cmd>lua require'nvim.yazi'.open('tabnew')<cr>]],
        ["<C-e><C-v>"] = [[<cmd>lua require'nvim.yazi'.open('vsplit')<cr>]],
        ["<C-e><C-x>"] = [[<cmd>lua require'nvim.yazi'.open('split')<cr>]],
